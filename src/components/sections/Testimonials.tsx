...
const testimonials: Testimonial[] = [
  {
    ...
    company: "Designify",
    quote: "The Vision AR glasses have completely transformed my workflow. I can visualize 3D models in real space while collaborating with my team remotely. The display quality is unmatched.",
    ...
    >
      <div className="flex items-start mb-6">
        <div className="relative">
          ...
          {/* Decorative element */}
          <div className="absolute -bottom-1 -right-1 w-5 h-5 rounded-full bg-orange-600 flex items-center justify-center">
      ...
      <div className="relative mb-4">
        <div className="absolute -top-5 -left-1 text-5xl text-orange-600/20">"</div>
        <p className="text-neutral-600 dark:text-neutral-300 relative z-10 font-light">
          {testimonial.quote}
        </p>
        <div className="absolute -bottom-10 -right-1 text-5xl text-orange-600/20">"</div>
      </div>
...
const Testimonials = () => {
  ...
  return (
    <section id="testimonials" className="py-28 px-4 md:px-6 bg-neutral-50 dark:bg-[#0A0A0A] relative overflow-hidden">
      ...
      <div className="absolute top-20 left-10 w-48 h-48 bg-orange-600/5 rounded-full blur-3xl"></div>
      <div className="absolute bottom-20 right-10 w-48 h-48 bg-orange-600/5 rounded-full blur-3xl"></div>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          >
            Early adopters share their experiences with Vision AR
          </motion.p>
        </motion.div>
        
        {/* Quote mark */}
        <div className="flex justify-center mb-12">
          <div className="w-16 h-16 rounded-full bg-orange-100 dark:bg-orange-900/20 flex items-center justify-center text-orange-600">
